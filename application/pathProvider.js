    ...
    //0 SUPPORTS DOWN
    {
        ...
        "toolTips":{
            "0": `<h3>ДЛЯ ВЫДАЧИ КОМАНДЫ С ППО:</h3>
                    ...
                    <h5><li> ОТКРОЙТЕ КРЫШКУ ППО</h5>
                    <h5><li> ПОВЕРНИТЕ ВЫКЛЮЧАТЕЛЬ БЕЗОПОСНОСТИ В ПОЛОЖЕНИЕ 'ВКЛ'</li></h5>
                    <h5><li> СНИМИТЕ МЕХАНИЧЕСКУЮ БЛОКИРОВКУ</li></h5>`,
    ...
    { 
        ...
        "toolTips":{
            "0": `<h3>ДЛЯ ВЫДАЧИ КОМАНДЫ С ППО:</h3>
                    <h5><li> ПОВЕРНИТЕ ВЫКЛЮЧАТЕЛЬ БЕЗОПОСНОСТИ В ПОЛОЖЕНИЕ 'ВКЛ'</li></h5>
                    <h5><li> ОТКРОЙТЕ КРЫШКУ ОТСЕКА №1 </li></h5>
                    <h5><li> ОТКРОЙТЕ КРЫШКУ ППО</li></h5>
                    <h5><li> СНИМИТЕ МЕХАНИЧЕСКУЮ БЛОКИРОВКУ</li></h5>
                    `,
    ...
    //2  SUPPORTS UP
    {
        ...
        "toolTips":{
            ...
            "13h0v": `<h3> ПОДНИМИТЕ ДОМКРАТЫ:</h3>
                        ...
                        <h5>1) ПОВЕРНИТЕ ПЕРЕКЛЮЧАТЕЛЬ ППK В ПОЛОЖЕНИЕ 'ОПУСК ТПК'</h5>
                        <h5>2) НАЖМИТЕ КНОПКУ 'ВКЛ'</h5>`,
    ...
    //4 SUPPORTS DOWN
    {
        ...
        "toolTips":{
            "0":   `<h3>ДЛЯ ВЫДАЧИ КОМАНДЫ С ППК:</h3>
                    ...
                    <h5><li>ОТКРОЙТЕ КРЫШКУ ОТСЕКА №1</li></h5>
                    <h5><li>ОТКРОЙТЕ КРЫШКУ ППО</li></h5>
                    <h5><li>ПРОВЕРЬТЕ ИНДИКАЦИЮ ЛАМПЫ 'ДИСТ'</li></h5>
                    `,
    ...
    //5 TPK UP
    {
        ...
        "toolTips":{
            ...
            "dckf72":`<h3>ПОДНИМИТЕ ТПК:</h3>
                        ...
                        <li>ЛИБО ОПУСТИТЕ ДОМКРАТЫ ВРУЧНУЮ:</li>
                        <h5>1) ПОВЕРНИТЕ ПЕРЕКЛЮЧАТЕЛЬ ППК В ПОЛОЖЕНИЕ 'СПУСК. ДОМКР.'</h5>
                        <h5>2) НАЖМИТЕ КНОПКУ 'ВКЛ'</h5>`,
    ...
    { 
        ...
        "toolTips":{
            ...
            "eofhu2": `<h3> ПОДНИМИТЕ ДОМКРАТЫ:</h3>
                        ...
                        <h5>1) ПОВЕРНИТЕ ПЕРЕКЛЮЧАТЕЛЬ ППK В ПОЛОЖЕНИЕ 'ОПУСК ТПК'</h5>
                        <h5>2) НАЖМИТЕ КНОПКУ 'ВКЛ'</h5>`,
            "1amg62": `<h3>ОТДАЙТЕ КОМАНДУ 'ОТ ПУСКОВОЙ!'</h3>`,
