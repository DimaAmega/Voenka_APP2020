...
var ObjectsContainer = function() {
    ...
    var loadObject = function (PathToObject) {
        return new Promise(function (resolve, reject) {
            loader.load(
                PathToObject,
                (Obj) => { Obj.name = PathToObject; resolve(Obj) },
    ...
    this.updateAnimations = function (delta) {
        for (var i = 0; i < Object_arr.length; i++) Object_arr[i].updateAnimations(delta);
    };
    //setPathToModels
    this.setPathToModels = function (pathToDirWith3dModels) { loader.setPath(pathToDirWith3dModels); };
};
