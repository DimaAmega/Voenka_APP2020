...
// PRIVATE METHODS
    ...
    _applyState(state)
    {
        ...
        for (sceneObjects in this.m_objects)
        {
            // TODO Dmitry Horkin use sceneObjects.applyState please
            // stateApplied = sceneObjects.applyState(requiredState[sceneObjects.name])
            stateApplied = sceneObjects.state = requiredState[sceneObjects.name];
        }
